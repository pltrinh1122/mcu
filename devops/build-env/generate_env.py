...
class EnvironmentGenerator:
    ...
    def generate_environment(self, component_name: str, config: Dict[str, Any] = None) -> None:
        ...
        # Copy template
        print(f"Copying template to {env_dir}...")
        shutil.copytree(self.template_dir, env_dir)
        ...
        print(f"Environment generated: {env_dir}")
        print("\nNext steps:")
        print(f"  1. cd {env_dir}")
        print(f"  2. Edit env-config.yaml if needed")
        print(f"  3. ./scripts/setup-env.sh")
